...
- (void)HTTPConnection:(CKHTTPConnection *)connection didReceiveResponse:(NSHTTPURLResponse *)response {
    ...
    NSMutableDictionary *settings = [[TorManager sharedManager]settings];
...
- (NSData *)htmlDataWithJavascriptInjection:incomingData {
    ...
    [newData appendData:[[NSString stringWithFormat:@"<!DOCTYPE html><script>%@</script>", [[TorManager sharedManager]javascriptInjection]] dataUsingEncoding:NSUTF8StringEncoding]];
...
- (NSData *)javascriptDataWithJavascriptInjection:incomingData {
    ...
    [newData appendData:[[NSString stringWithFormat:@"%@\n", [[TorManager sharedManager]javascriptInjection]] dataUsingEncoding:NSUTF8StringEncoding]];
    [newData appendData:incomingData];
    return newData;
}
@end
